...
class ThemetonMetaPost extends TTRenderMeta{
    ...
    public function post_images_box() {
                    ...
                    if ( $attachments )
                        foreach ( $attachments as $attachment_id ) {
                            echo '<li class="image" data-attachment_id="' . $attachment_id . '">
                                ...
                                <ul class="actions">
                                    <li><a href="#" class="delete" title="' . esc_attr__('Delete image', 'nrgbusiness') . '">' . esc_attr__('Delete', 'nrgbusiness') . '</a></li>
                                </ul>
                            </li>';
                        }
                ?>
        ...
        <p class="add_post_images hide-if-no-js">
            <a href="#"><?php esc_attr_e('Add post gallery images', 'nrgbusiness'); ?></a>
        </p>
        <?php
    }
    ...
    public function post_meta_boxes(){
        global $post;
        add_meta_box( 'post-images', esc_attr__('Post Gallery', 'nrgbusiness'), array($this, 'post_images_box'), 'post', 'side' );
    }
