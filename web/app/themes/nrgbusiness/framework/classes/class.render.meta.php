...
=======================================*/
global $nrgbusiness_sliders;
$nrgbusiness_sliders = array("none" => 'No slider');
$nrgbusiness_sliders = array_merge($nrgbusiness_sliders, TT::get_sliders('layerslider'));
$nrgbusiness_sliders = array_merge($nrgbusiness_sliders, TT::get_sliders('revslider'));
$nrgbusiness_sliders = array_merge($nrgbusiness_sliders, TT::get_sliders('masterslider'));
