...
class WPSEO_Options_Extend {
    ...
    public static function get_all() {
        ...
        $all_options['breadcrumbs-404crumb']      = __('Error 404: Page not found', 'nrgbusiness');
        $all_options['breadcrumbs-archiveprefix'] = __('Archives for', 'nrgbusiness');
        $all_options['breadcrumbs-home']          = __('Home', 'nrgbusiness');
        $all_options['breadcrumbs-searchprefix']  = __('You searched for', 'nrgbusiness');
...
function theme_breadcrumb( $before = '', $after = '', $display = true ) {
