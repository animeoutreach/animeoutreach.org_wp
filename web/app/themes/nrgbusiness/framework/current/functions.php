...
require_once nrgbusiness_file_require(get_stylesheet_directory() . '/framework/current/ExtendVCRow.php');


// Import VC Custom Elements
if( function_exists('vc_map') ){
    $file_dir = nrgbusiness_file_require( get_stylesheet_directory().'/framework/current/vc-elements/' );
