...
class nrgbusiness_SocialLinksWidget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if ($title) {
            ...
            echo '<div class="ftr-social f-ftr-social">';

        foreach ($nrgbusiness_social_icons as $social => $icon) {
            if (isset($instance['social_' . $social]) && $instance['social_' . $social] != "") {
                ...
                echo '<a class="social-network" href="'.$url.'" data-position="bottom" data-delay="30"><i class="fa fa-'.$icon.'"></i></a>';
            }
        }
    ...
    function form($instance) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Widget Title:', 'nrgbusiness'); ?></label>
...
add_action('widgets_init', create_function('', 'return register_widget("nrgbusiness_SocialLinksWidget");'));
?>
